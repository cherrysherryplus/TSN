...
class AccuracyRobustnessBenchmark:
    ...
    def _calculate_accuracy_robustness(self, tracker_name):
        ...
        for i in range(len(self.dataset)):
            ...
            print("=============>  tracker_name = {}    ".format(tracker_name))
            print("=============>  video.pred_trajs = {}    ".format(video.pred_trajs))
            ...
            overlaps_group = []
            num_failures_group = []
            #print("===========>   gt_traj = {}".format(gt_traj))
            #for tracker_traj in tracker_trajs:
            #print("-------------------->  tracker_traj = {}".format(tracker_traj))
            num_failures = calculate_failures(tracker_trajs)[0]
            overlaps_ = calculate_accuracy(tracker_trajs, gt_traj,
