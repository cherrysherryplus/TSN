...
def ca():
    path='./test_datasets_demo/small112'
...
class Small112Video(Video):
    ...
    def __init__(self, name, root, video_dir, init_rect, img_names,
        ...
        super(Small112Video, self).__init__(name, root, video_dir,
                init_rect, img_names, gt_rect, attr, load_img)


class Small112Dataset(Dataset):
    """
    Args:
        name: dataset name, should be 'Small112'
        dataset_root: dataset root
        load_img: wether to load all imgs
    """
    def __init__(self, name, dataset_root, load_img=False):
        super(Small112Dataset, self).__init__(name, dataset_root)
        meta_data = ca()
        ...
        for video in pbar:
            ...
            self.videos[video] = Small112Video(video,
                                          dataset_root,
