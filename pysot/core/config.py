...
__C.DATASET.NAMES = ['GOT','VID','LaSOT','COCO']
...
# {'lr': params[0], 'penalty_k':params[1], 'window_lr':params[2]}
# ------------------------------------------------------------------------ #
__C.HP_SEARCH = CN()

__C.HP_SEARCH.OTB100 = [0.7, 0.1, 0.6]
...
# original(TSN's)
__C.HP_SEARCH.UAV10fps = [0.65161945685940692, 0.03199749012304991, 0.25743471313112970]

# original(TSN's)
__C.HP_SEARCH.UAV20l = [0.9052892036700073, 0.83884088970616921, 0.24027679699215188]

# original(TSN's)
__C.HP_SEARCH.DTB70 = [0.9892017821710478, 0.2628115687251515, 0.368513688197764]

# original(TSN's)
__C.HP_SEARCH.VisDrone2019 = [0.23465458805930073, 0.23308511834111489, 0.51381545756125879]

# original(TSN's)
__C.HP_SEARCH.LaTOT = [0.4699322981196671, 0.33385217748075313, 0.31660622557848606]

# original(TSN's)
__C.HP_SEARCH.LaTOTfull = [0.4699322981196671, 0.33385217748075313, 0.31660622557848606]

# original(TSN's)
__C.HP_SEARCH.small90 = [0.3714533642700367,0.2779256860869477,0.9687810903194525]
__C.HP_SEARCH.small112 = [0.3714533642700367,0.2779256860869477,0.9687810903194525]
